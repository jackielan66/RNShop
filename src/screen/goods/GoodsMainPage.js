...
import * as API_Promotions from '../../api/promotions-api';
import * as API_Shop from '../../api/shop-api';
    ...
    _onSelectSpec = async (spec, specIndex, specVal) => {
        ...
        if (selectedSku) {
            ...
            DeviceEventEmitter.emit(
                `SelectedSkuChange-${goods.goods_id}`,
                selectedSku,
            );
